    ...
    <div id="about-section" className={AboutStyles.aboutInfo}>
      ...
      <div className={AboutStyles.contact}>
        ...
        <div className={AboutStyles.contactInner}>
          <div data-tip="Copy my email to your clipboard" className={AboutStyles.contactEmail}>
            <Clipboard></Clipboard>
          </div>
          <a data-tip="Copy my email to your clipboard" href="https://www.linkedin.com/in/tammo-feldmann/">
